...
#ifndef _4ti2_qsolve__VectorArrayAPI_
#define _4ti2_qsolve__VectorArrayAPI_
...
template <class T>
VectorArrayAPI<T>::VectorArrayAPI(Size m, Size n)
    : data(m, n)
{
}
...
template <class T>
void
VectorArrayAPI<T>::init(Size m, Size n)
{
    data.init(m, n);
}
...
{
    type_conversion(value, data[r][c]);
}
...
{
    type_conversion(data[r][c], value);
}
