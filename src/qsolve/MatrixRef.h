...
#ifndef _4ti2_qsolve__MatrixRef_
#define _4ti2_qsolve__MatrixRef_
...
class MatrixRef : public _4ti2_matrix {
public:
    MatrixRef(MatrixT& _m);
...
#define _MatrixRef_declare_(TYPE) \
    virtual void set_entry(int r, int c, const TYPE& v);  \
    virtual void get_entry(int r, int c, TYPE& v) const;

    _MatrixRef_declare_(int32_t)
    _MatrixRef_declare_(int64_t)
#ifdef _4ti2_GMP_
    _MatrixRef_declare_(mpz_class)
#endif
