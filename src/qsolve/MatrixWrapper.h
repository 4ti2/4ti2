...
#ifndef _4ti2_qsolve__MatrixWrapper_
#define _4ti2_qsolve__MatrixWrapper_
...
class MatrixWrapper : public _4ti2_matrix, public MatrixT {
public:
    MatrixWrapper();
    MatrixWrapper(Size m, Size n);
...
#define _MatrixWrapper_declare_(TYPE) \
    virtual void set_entry(int r, int c, const TYPE& v);  \
    virtual void get_entry(int r, int c, TYPE& v) const;

    _MatrixWrapper_declare_(int32_t)
    _MatrixWrapper_declare_(int64_t)
#ifdef _4ti2_GMP_
    _MatrixWrapper_declare_(mpz_class)
#endif
...
#include "qsolve/MatrixWrapper.hpp"
