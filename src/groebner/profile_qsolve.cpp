...
main(int argc, char **argv)
{
    ...
    // For profiling purposes, compute it a few thousand times. --mkoeppe

    VectorArray* subspace = NULL;
    ...
    for (i = 0; i<10000; i++) {
      ...
      if (rays) delete rays;
      if (subspace) delete subspace;
      if (circuits) delete circuits;
      
      rays = new VectorArray(0, matrix_copy->get_size());
      lattice_basis(*matrix_copy, *rays);
